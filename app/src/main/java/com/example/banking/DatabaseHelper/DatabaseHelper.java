...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into Table1 values(6301547854,'Shivam',15000.00,'shivam@gmail.com','XXXXXXXXXXXX3021','IBI43210987')");;
        db.execSQL("insert into Table1 values(9264909949,'Adi',5000.00,'adi@gmail.com','XXXXXXXXXXXX1247','IBI08576543')");
        db.execSQL("insert into Table1 values(7854120214,'Devang',3000.00,'devang@gmail.com','XXXXXXXXXXXX7433','IBI65432109')");
        db.execSQL("insert into Table1 values(7452301259,'Nevunder',6000.00,'nevunder@gmail.com','XXXXXXXXXXXX7451','IBI87654321')");
        db.execSQL("insert into Table1 values(8542136521,'Joy Dey',7000.00,'joyd@gmail.com','XXXXXXXXXXXX6521','IBI98765432')");
        db.execSQL("insert into Table1 values(9471203215,'Devika',9000.00,'devika@gmail.com','XXXXXXXXXXXX5201','IBI76543210')");
        db.execSQL("insert into Table1 values(9517538246,'Grey',5000.00,'grey@gmail.com','XXXXXXXXXXXX3456','IBI21098765')");
        ...
        db.execSQL("insert into Table1 values(3652148796,'Bhargav',25000.00,'bhargav@gmail.com','XXXXXXXXXXXX3959','IBI10987654')");
    }
